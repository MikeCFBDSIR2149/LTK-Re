...
public class UIManager : MonoBehaviour
{
    ...
    public void ShowPanel<T>(E_UILayer layer = E_UILayer.Middle, UnityAction<T> callBack = null, bool isSync = false) where T : UIPanel
    {
    ...
    /// <returns></returns>
    public T GePanel<T>() where T : UIPanel
    {
        string panelName = typeof(T).Name;
        if (panelDic.ContainsKey(panelName))
